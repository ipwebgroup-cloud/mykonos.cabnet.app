...
- keep admin terminology readable with hover tooltips while exposing one centralized right-side docs/help/glossary system across Inquiry Queue, Loyalty Continuity list, and loyalty create/update screens
