...
- keep the queue toolbar wrapping cleanly on narrower widths
- inspect whether the top filter row also needs spacing hardening
- continue reducing avoidable crowding before adding any new UI chrome
