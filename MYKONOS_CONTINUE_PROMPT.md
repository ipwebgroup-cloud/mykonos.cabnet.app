...
- keep the Inquiry Queue scan-friendly by using queue-view presets, simple 5 / 10 / 50 / All row controls, lighter repeat-guest summary rendering on each row, and tighter status / priority / owner / follow-up summary columns so more inquiries fit on screen at once
