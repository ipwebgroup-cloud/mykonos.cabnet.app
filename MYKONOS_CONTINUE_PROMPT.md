...
- stable toolbar and filter wrapping
- shorter filter and list labels
- lighter default visible list columns
- compact inquiry and loyalty top summaries
...
- keep both list pages focused on scan-first defaults
- continue reducing repeated visible wording before adding more UI chrome
- inspect whether queue row partials can compress further
