...
- keep those linked-row loyalty cards and queue-side actions visually compact so one loyalty-linked inquiry row consumes less width and height during faster scan passes
